    ...
    <div className='mt-2 flex space-x-4'>
      <div className='flex items-center justify-center'>
        ...
        >
          ...
          >
            <FiMail className='h-7 w-7 pb-1 align-middle text-gray-600 hover:text-primary-300 dark:text-gray-300 dark:hover:text-primary-300' />
          </button>
        </Tooltip>
      </div>
      {socials.map((social) => (
...
const socials: Social[] = [
  ...
  {
    href: 'https://twitter.com/Shinki60011657',
    icon: SiTwitter,
    id: 'Twitter',
    text: (
      <>
